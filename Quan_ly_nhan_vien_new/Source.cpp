...
class Nhan_Vien_Sua_Ong_nuoc :public Nhan_Vien
{
private:
	float SoGioSua;
public:
...
class Nhan_Vien_Giao_Hang :public Nhan_Vien
{
private:
	int SoHangGiao;
public:
...
class Nhan_Vien_Xe_Om :public Nhan_Vien
{
private:
	float SoKm;
public:
...
void Menu(Nhan_Vien_Sua_Ong_nuoc* ds_nv_sua_ong_nuoc[], Nhan_Vien_Giao_Hang* ds_nv_giao_hang[], Nhan_Vien_Xe_Om* ds_nv_xe_om[], int n, int m, int l)
{
	...
	while (true)
	{
		...
		{
			Nhan_Vien_Sua_Ong_nuoc* nv_suaongnuoc = new Nhan_Vien_Sua_Ong_nuoc();
		...
		{
			Nhan_Vien_Giao_Hang* nv_giaohang = new Nhan_Vien_Giao_Hang();
		...
		{
			Nhan_Vien_Xe_Om* nv_xeom = new Nhan_Vien_Xe_Om();
		...
		else if (luachon == 8)
		{
			...
			cout << "\n\n\t\tDANH SACH GIAM DAN NHAN VIEN XE OM\n";
...
int main()
{
	...
	int m = 0;
	int l = 0;
	Nhan_Vien_Sua_Ong_nuoc* ds_suaongnuoc[100];
	Nhan_Vien_Giao_Hang* ds_giaohang[100];
	Nhan_Vien_Xe_Om* ds_xeom[100];
